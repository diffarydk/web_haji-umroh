...
class Formulir extends Database{
    ...
    public function Tambah_data(){
      ...
      '$this->no_telp_keluarga', '$this->foto', '$this->tanggal_keberangkatan', '$this->maskapai', '$this->tanggal_pulang', '$this->timestamp', '$this->status')";
